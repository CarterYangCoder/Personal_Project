...
Page({
  data: {
    ...
    tasks: [], taskGroups: [], quadrants: [], todayCount: 0, openTasks: 0, completedCount: 0,
    ...
    timerMode: 'focus', timerRunning: false, rounds: 0
  },
  ...
  editTask(e) {
    ...
    this.setData({
      ...
      statusIndex: Math.max(0, STATUS_OPTIONS.indexOf(task.status)), scrollTarget: ''
