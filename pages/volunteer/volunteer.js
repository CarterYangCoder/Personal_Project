...
Page({
  data: { projects: volunteerProjects, projectNames: volunteerProjects.map(item => item.name), projectIndex: 0, activeId: null, intents: [], isLoggedIn: false },
  ...
  async submitIntent(e) {
    ...
    this.setData({ intents: result.records })
